      ...
      <div className="flex flex-col gap-4 h-screen bg-slate-300 p-4">
        ...
        <form onSubmit={log} className="text-black">
          ...
          <FormInput
            ...
            name="entregadorDtNascimento"
          />
          <FormInput
            type="number"
            title="Fone Celular"
            name="entregadorFoneCelular"
            required={true}
          />
          <FormInput
            type="number"
            title="Fone Fixo"
            name="entregadorFoneFixo"
          />
          <FormInput
            type="number"
            title="Quantidade de entregas realizadas"
            name="entregadorQER"
          />
          <FormInput
            type="number"
            title="Valor por frete"
            name="entregadorValorFrete"
          />
